...
if btn:
    webbrowser.open_new_tab( 'https://www.kaggle.com/datasets/gauravmalik26/food-delivery-dataset?select=train.csv' )
...
with tab1:
    ...
    with st.container():
        ...
        with col2:
            ...
            st.dataframe( df_aux, width=2020, height=480, use_container_width=True )       
